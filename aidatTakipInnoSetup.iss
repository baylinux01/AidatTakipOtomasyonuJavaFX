...
AppId={{421887E2-8E61-4C1A-B41C-69C2C4473544}
AppName={#MyAppName}
...
LicenseFile=G:\aidatTakipOtomasyonu\LICENSE.txt
; Remove the following line to run in administrative install mode (install for all users.)
PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=commandline
OutputDir=G:\aidatTakipOtomasyonu
...
[Files]
Source: "G:\aidatTakipOtomasyonu\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "G:\aidatTakipOtomasyonu\aidatTakipLogo.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "G:\aidatTakipOtomasyonu\LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
